...
export type EditGenreFormData = z.infer<typeof EditGenreFormSchema>;

// usecase
export const UsecaseEditGenreInputSchema = EditGenreFormSchema;
export type UsecaseEditGenreInput = EditGenreFormData;

// repository
export type RepositoryEditGenreInput = {
